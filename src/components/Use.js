    ...
    return (
        <div>
            ...
            <div id="pragraph2">
                ...
                <ul>
                    <li id="individual">For prediction based on previous years’ opening as well as closing rank click ‘SOCE Prediction’ and then ‘Default Prediction’. </li>
                    <li id="individual">Fill all the desired details and click ‘Submit’</li>
                    <li id="individual">Click ‘Click to Get Prediction’ on next page</li>
